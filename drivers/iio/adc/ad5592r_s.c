...
#define AD5592R_S_REG_CONFIG_READBACK 	0x7
...
static int ad5592r_s_spi_read_ctl(struct ad5592r_s_state *st, u8 reg, u16 *val){ // reg e adresa
	...
	msg |= FIELD_PREP(AD5592R_S_ADDR_MASK, AD5592R_S_REG_CONFIG_READBACK);
...
static int ad5592r_s_spi_write(struct ad5592r_s_state *st, u8 reg, u16 val){
	...
	struct spi_transfer xfer = {
		.tx_buf = &tx,
		.len = 2, // 2 pt ca scriem: 1 pt a anunta ca scriem datele, 1 pt locul unde le scriem
	};
...
MODULE_AUTHOR("Denisa-Bianca Retian <denisaretian@gmail.com>");
